      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col items-center md:items-start">
            <Image src="/presta-conta-logo.svg" alt="PrestaConta Logo" width={180} height={40} className="mb-4" />
            <p className="text-sm text-gray-600 mb-4 text-center md:text-left">
              Portal de transparência da Associação de Assistência ao Menor de Platina (AMPLA)
            </p>
          </div>
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="mt-6 flex justify-center md:justify-start">
              <Link href="https://site.integriguard.com.br" target="_blank" rel="noopener noreferrer">
                <Image
                  src="/logo-letras-pretas.png"
                  alt="IntegriGuard Logo"
                  width={150}
                  height={40}
        ...
        <div className="mt-8 border-t border-gray-200 pt-6 text-center">
          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} PrestaConta. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
